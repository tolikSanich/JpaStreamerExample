-- Organization
insert into organization(name) values('Magnit');
insert into organization(name) values('Pyaterka');
-- Department
insert into department(name, organization_id) values('Salary', 1);
insert into department(name, organization_id) values('Engeenear', 1);
insert into department(name, organization_id) values('Revizions', 2);
insert into department(name, organization_id) values('BookKeaper', 2);
-- Employee
